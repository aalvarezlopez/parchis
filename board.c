...
void drawCells(WINDOW **windows)
{
    ...
    drawVerticalCells(windows, 6*HCELL_HEIGHT, 7*VCELL_HEIGHT+(2*HCELL_WIDTH), 26, 2,
        CELLSHOME, 6, DECREMENTION);
...
void drawCenter(WINDOW **windows)
{
    ...
    drawInernalCell(windows,CORNER2, 7*HCELL_HEIGHT+(VCELL_WIDTH/2), 7*VCELL_HEIGHT, 1);
    drawInernalCell(windows,CORNER3, 7*HCELL_HEIGHT+(2*VCELL_WIDTH), 7*VCELL_HEIGHT, 2);
    drawInernalCell(windows,CORNER4, 7*HCELL_HEIGHT+((5*VCELL_WIDTH)/2), 7*VCELL_HEIGHT, 3);
    drawInernalCell(windows,CORNER6, 7*HCELL_HEIGHT+2*VCELL_WIDTH, 7*VCELL_HEIGHT+2*HCELL_WIDTH, 5);
    drawInernalCell(windows,CORNER5, 7*HCELL_HEIGHT+((5*VCELL_WIDTH)/2), 7*VCELL_HEIGHT+2*HCELL_WIDTH, 4);
    drawInernalCell(windows,CORNER7, 7*HCELL_HEIGHT+VCELL_WIDTH/2, 7*VCELL_HEIGHT+2*HCELL_WIDTH, 7);
    drawInernalCell(windows,CORNER8, 7*HCELL_HEIGHT, 7*VCELL_HEIGHT+2*HCELL_WIDTH, 6);
}
